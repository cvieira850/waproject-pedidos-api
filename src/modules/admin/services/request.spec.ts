...
describe('Admin/RequestService', () => {
  ...
  it('should update a request', async () => {
    jest.spyOn(requestRepository, 'findById').mockResolvedValueOnce({ isSysAdmin: () => false } as any);
  ...
  it('should remove a request', async () => {
    jest.spyOn(requestRepository, 'findById').mockResolvedValueOnce({ id: 2, isSysAdmin: () => false } as any);
